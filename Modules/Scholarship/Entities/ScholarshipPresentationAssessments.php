...
{
    protected $fillable = ['period_id', 'jury_id', 'student_id', 'submission_id', 'score_A', 'score_B', 'score_C', 'score_D', 'score_E', 'score_F', 'score_G', 'score_H', 'score_I', 'score_J', 'final_score'];
